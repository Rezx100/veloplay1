    ...
    <div className="rounded-lg overflow-hidden shadow-2xl relative aspect-video border border-purple-800/30">
      ...
      <div className="relative z-10 h-full flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-3 sm:px-6">
          {/* Team Matchup - Balanced Spacing */}
          <div className="flex items-center justify-center gap-8 sm:gap-16 lg:gap-20 mb-6 sm:mb-8 px-2">
            {/* Away Team */}
            <div className="text-center flex-1 max-w-[120px] sm:max-w-[180px] lg:max-w-none">
              <div className="w-16 h-16 sm:w-32 sm:h-32 lg:w-36 lg:h-36 mx-auto mb-3 sm:mb-4 lg:mb-5 bg-white/10 rounded-full p-2 sm:p-4 lg:p-5 flex items-center justify-center backdrop-blur-sm border border-white/20">
                <img 
                  src={game.awayTeam.logo} 
                  alt={game.awayTeam.name}
                  className="w-12 h-12 sm:w-24 sm:h-24 lg:w-26 lg:h-26 object-contain"
                />
              </div>
              <h3 className="font-bold text-white text-base sm:text-2xl lg:text-3xl mb-1">{game.awayTeam.abbreviation}</h3>
              <p className="text-purple-200 text-xs sm:text-base lg:text-lg font-medium leading-tight">{game.awayTeam.name}</p>
            </div>
            
            {/* VS Section - Compact */}
            <div className="flex-shrink-0 mx-2 sm:mx-6 lg:mx-8">
            ...
            <div className="text-center flex-1 max-w-[120px] sm:max-w-[180px] lg:max-w-none">
              ...
              <h3 className="font-bold text-white text-base sm:text-2xl lg:text-3xl mb-1">{game.homeTeam.abbreviation}</h3>
              <p className="text-purple-200 text-xs sm:text-base lg:text-lg font-medium leading-tight">{game.homeTeam.name}</p>
            </div>
          </div>

          {/* Countdown Timer - Compact Spacing */}
          <div className="text-center mb-4 sm:mb-6 lg:mb-8">
            <div className="text-3xl sm:text-6xl lg:text-7xl font-bold text-white mb-2 sm:mb-3 lg:mb-4 font-mono tracking-wide drop-shadow-lg">
              {timeRemaining}
            </div>
            <p className="text-purple-200 text-sm sm:text-xl lg:text-2xl font-medium">Until Game Time</p>
          </div>

          {/* Game Details - Compact Cards */}
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 lg:gap-8 mb-4 sm:mb-6 lg:mb-8 w-full">
