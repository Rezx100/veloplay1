...
export function PreGameTemplate({ game, onStreamStart }: PreGameTemplateProps) {
  ...
  const getStadiumBackground = (league: string) => {
    const stadiumImages = {
      'mlb': 'https://images.unsplash.com/photo-1625226756831-04f6506bc593?w=1200&h=800&fit=crop', // Baseball stadium
      'nfl': 'https://images.unsplash.com/photo-1577223625816-7546f74bb7d1?w=1200&h=800&fit=crop', // Football stadium
      'nba': 'https://images.unsplash.com/photo-1546519638-68e109498ffc?w=1200&h=800&fit=crop', // Basketball arena
      'nhl': 'https://images.unsplash.com/photo-1515703407324-5f753afd8be8?w=1200&h=800&fit=crop'  // Hockey arena
    };
